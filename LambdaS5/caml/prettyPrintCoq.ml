...
let rec format_expr b e = match e with
    ...
    | Coq_expr_get_internal (a, e1) -> coqconstr b "expr_get_obj_attr" [format_id a; format_expr true e1]
    | Coq_expr_set_internal (a, e1, e2) -> coqconstr b "expr_set_obj_attr" [format_id a; format_expr true e1; format_expr true e2]
